...
try {
    ...
    # Run connect command
    & "$env:ProgramW6432\AzureConnectedMachineAgent\azcmagent.exe" connect --service-principal-id "$ServicePrincipalId" --service-principal-secret "$ServicePrincipalClientSecret" --resource-group "$env:RESOURCE_GROUP" --tenant-id "$env:TENANT_ID" --location "$env:LOCATION" --subscription-id "$env:SUBSCRIPTION_ID" --cloud "$env:CLOUD" --private-link-scope "/subscriptions/5354456f-0232-435c-af4f-15b64e77c1cb/resourceGroups/BCIRG3POC-RG-LPS001/providers/Microsoft.HybridCompute/privateLinkScopes/bcirg3pocpelps001" --correlation-id "$env:CORRELATION_ID";
}
catch {
